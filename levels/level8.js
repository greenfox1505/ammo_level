...
function layer(offsetVect,isOdd) {
    for (var i = 0; i < 32; i++) {
        var angleOffset = isOdd?1/64:0
        var v = new THREE.Vector3(5.5, 0, 0);
        v.applyAxisAngle(new THREE.Vector3(0, 1, 0), (i/32+ angleOffset)*Math.PI*2).add(offsetVect);
        var brick = ["brick", "box"+(i%4), [v.x, v.y, v.z], [0, i/32+1/4 + angleOffset, 0]]
